...
class Pokemon {
    ...
    //data protection and we will not have crashes
    ...
    func  downloadPokemonDetail(completed: DownloadComplete) {
        ...
        Alamofire.request(_pokemonURL, withMethod: .get, parameters: nil, encoding: .url, headers: nil).responseJSON { (Response) in
